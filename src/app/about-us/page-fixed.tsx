  ...
  return (
    <PublicWebsiteLayout>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-primary/5 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-6 mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-primary mb-4 text-center">Our Mission</h3>
            ...
            <div className="bg-secondary/5 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-secondary mb-4 text-center">Our Vision</h3>
              <p className="text-gray-700 text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Excellence</h3>
              <p className="text-gray-700 text-center">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Integrity</h3>
              <p className="text-gray-700 text-center">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Global Perspective</h3>
              <p className="text-gray-700 text-center">
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 to-secondary/10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary mb-4">Our Faculty & Staff</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2 text-primary">Experienced Educators</h3>
            ...
            >
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2 text-primary">Supportive Administration</h3>
                <p className="text-gray-700">
            ...
            >
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2 text-primary">Dedicated Support Staff</h3>
                <p className="text-gray-700">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.1 }}
              className="bg-primary/5 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow"
            >
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4 mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Address</h3>
              <p className="text-gray-700 text-center">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Phone</h3>
              <p className="text-gray-700 text-center">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-primary mb-2 text-center">Email</h3>
              <p className="text-gray-700 text-center">
